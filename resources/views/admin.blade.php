			...
			<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
				...
				<div class="brand flex-column-auto" id="kt_brand">
					...
					<a href="index.html" class="brand-logo">
						<img alt="Logo" src="https://medpip.com/mag/wp-content/uploads/2020/10/pip-logo-fa.png" height="48px" />
					</a>
					<!--end::Logo-->
					<!--begin::Toggle-->
						...
						<div class="topbar">
							...
							<div class="topbar-item">
								<form action="{{ route('logout') }}" method="POST">
									@csrf
									<button type="submit" class="btn btn-transparent-danger font-weight-bold mr-2">خروج</button>
								</form>
							</div>
							<!--end::User-->
						</div>
