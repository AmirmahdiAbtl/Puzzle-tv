...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>پل ایده‌آل پارس | LabTest</title>
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <!--begin::Logo-->
        <a href="index.html">
            <img alt="Logo" src="https://medpip.com/mag/wp-content/uploads/2020/10/pip-logo-fa.png" height="32px" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    ...
                    <a href="index.html" class="brand-logo">
                        <img alt="Logo" src="https://medpip.com/mag/wp-content/uploads/2020/10/pip-logo-fa.png"
                            height="48px" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                            ...
                            <ul class="menu-nav">
                                <li class="menu-item {{ request()->is('admin') ? 'menu-item-active' : '' }}"
                                    ...
                                    <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false"
                                        class=" menu-link dropdown-toggle text-white">
                                        <span class="svg-icon menu-icon">
                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                            <img src="https://img.icons8.com/nolan/64/tv-show.png" width="30px" height="40px"/>
                                            <!--end::Svg Icon-->
                                        </span>
                                        <span>
                                            مدریت ویدیو ها
                                    ...
                                    <ul class=" text-decoration-none mx-2 collapse list-unstyled text-white"
                                        id="pageSubmenu">
                                        <li class=" mx-3 mt-2  text-white"><a class="text-white "
                                                href="{{ route('course.index') }}">
                                                <span class="svg-icon menu-icon my-2">
                                                    <img src="https://img.icons8.com/nolan/64/video.png" width="30px"
                                                        height="40px" />
                                        ...
                                        <li class=" mx-3 mt-2  text-white"><a class="text-white "
                                                ...
                                                <span class="svg-icon menu-icon my-2">
                                                    <img src="https://img.icons8.com/nolan/64/add-image.png"
                                        ...
                                        <li class=" mx-3 mt-2  text-white"><a class="text-white "
                                                ...
                                                <span class="svg-icon menu-icon my-2">
													<img src="https://img.icons8.com/nolan/64/sorting-answers.png" width="30px"
													height="40px"/>
                                                </span>
                                                <span>
									...
									<!-- for subscribtions -->
									<a href="#pageSubmenu_sub" data-toggle="collapse" aria-expanded="false"
                                        class=" menu-link dropdown-toggle text-white">
                                        <span class="svg-icon menu-icon">
                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<img src="https://img.icons8.com/nolan/64/pay-wall.png" width="30px"
											height="40px"/>
                                            <!--end::Svg Icon-->
                                        </span>
                                        <span>
                                    ...
                                    <ul class=" text-decoration-none mx-2 collapse list-unstyled text-white"
                                        ...
                                        <li class=" mx-3 mt-2  text-white"><a class="text-white "
                                                ...
                                                <span class="svg-icon menu-icon my-2">
                                                    <img src="https://img.icons8.com/nolan/64/membership-card.png"  width="30px" height="40px"/>
                                                    {{-- <!-- yadam bashe iconesho avaz konam --> --}}
                                                </span>
                                                <span>
                                                    نمایش تمامی اشتراک ها 
                                                </span>
                                            </a></li>
                                        <li class=" mx-3 mt-2  text-white"><a class="text-white "
