<div class="col-md-3 col-12 rounded" style="height: 78%; background-color:rgb(38, 38, 38)">
    <div class="d-flex justify-content-between flex-column pt-4 h-100 rounded" >
        ...
        <div class="pb-5">
            <!--begin::Header-->
            <div class="d-flex flex-column flex-center text-white">
                <!--begin::Symbol-->
                <div class="symbol symbol-120 symbol-circle symbol-100 overflow-hidden">
                    <span class="symbol-label">
                        <span class="svg-icon svg-icon-warning svg-icon-8x">
                            <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo7\dist/../src/media/svg/icons\General\User.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <div class="navi navi-bold  navi-active navi-link-rounded mt-7 rounded-xl w-100">
                    ...
                    <div class="navi-item rounded-0 mt-4 border-bottom border-light">
                        <a href="https://puzzle-stu.com/dashboard" class="navi-link py-4 rounded-0">
                            ...
                            <span class="navi-text font-size-lg font-weight-normal text-white">لیست تراکنش ها</span>
                        </a>
                    </div>
                   
                    <div class="navi-item rounded-0 border-bottom border-light">
                        <a href="https://puzzle-stu.com/dashboard/edit" class="navi-link py-4 rounded-0">
                            <span class="navi-icon mr-2">
                                <span class="svg-icon">
                            ...
                            <span class="navi-text font-size-lg font-weight-normal text-white">ویرایش حساب کاربری</span>
                        </a>
                    </div>

                    <div class="navi-item rounded-0 border-bottom border-light">
                        <a href="https://puzzle-stu.com/auth/logout" class="navi-link py-4 rounded-0">
                            <span class="navi-icon mr-2">
                                <span class="svg-icon svg-icon-danger">
                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-04-19-122603/theme/html/demo1/dist/../src/media/svg/icons/Navigation/Sign-out.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24"></rect>
                            ...
                            <span class="navi-text font-size-lg font-weight-normal text-danger text-white">خروج</span>
                        </a>
                    </div>
