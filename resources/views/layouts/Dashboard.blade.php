            ...
            <div class="d-flex flex-column flex-center text-white">
                ...
                <div class="navi navi-bold  navi-active navi-link-rounded mt-7 rounded-xl w-100">
                    <div class="navi-item rounded-0 mt-4 border-bottom border-light">
                        <a href="{{route('dashboard')}}" class="navi-link py-4 rounded-0">
                    ...
                    <div class="navi-item rounded-0 border-bottom border-light">
                        <a href="{{route('edit_user')}}" class="navi-link py-4 rounded-0">
                            <span class="navi-icon mr-2">
                                <span class="svg-icon">
                    ...
                    <div class="navi-item rounded-0 border-bottom border-light">
                            <form class="topbar-item" method="post" action="{{ route('logout') }}">
								...
								<button class="btn navi-text font-size-lg font-weight-normal text-danger text-white">خروج</button>
							</form>
                    </div>
                </div>
                <!--end::Info-->
