                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <div class="radio-inline mt-2">
                            <label class="radio radio-lg">
                                <input type="radio" name="status" value="1" @if($course->status) checked="checked" @endif />
                                <span></span>
                                اشتراکی
                            </label>
                            <label class="radio radio-lg">
                                <input type="radio" name="status" value="0" @if(!$course->status) checked="checked" @endif />
                                <span></span>
                                رایگان
                            </label>
                        </div>
