    ...
    <div class="card-body p-0">
        <div class="wizard wizard-1" id="kt_projects_add" data-wizard-state="step-first" data-wizard-clickable="true">
                ...
                <div class="wizard-steps p-8 p-lg-10">
                    <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                        <div class="wizard-label">
                            ...
                            <h3 class="wizard-title">@lang('admin/tests.step1.title')</h3>
                        </div>
                    ...
                    <div class="wizard-step" data-wizard-type="step">
                        <div class="wizard-label">
                            ...
                            <h3 class="wizard-title">@lang('admin/tests.step2.title')</h3>
                        </div>
                        <span class="svg-icon svg-icon-xl wizard-arrow">
                            <!--begin::Svg Icon | Arrow-Left-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <div class="wizard-step" data-wizard-type="step">
                        <div class="wizard-label">
                            ...
                            <h3 class="wizard-title">@lang('admin/tests.step3.title')</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                <div class="col-xl-12">
                    <!--begin::Form Wizard-->
                    <form class="form" id="kt_projects_add_form" method="post" action="{{ route('test.store') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <textarea class="form-control form-control-lg form-control-solid tinymce-light"
                                                ...
                                                placeholder="Why Get Tested?"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <textarea class="form-control form-control-lg form-control-solid tinymce-light"
                                                ...
                                                placeholder="When To Get Tested?"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <textarea class="form-control form-control-lg form-control-solid tinymce-light"
                                                ...
                                                placeholder="Sample Required?"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <textarea class="form-control form-control-lg form-control-solid tinymce-light"
                                                ...
                                                placeholder="Test Preparation Needed?"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <textarea class="form-control form-control-lg form-control-solid tinymce"
                                        ...
                                        placeholder="What is being tested?"></textarea>
                                </div>
                            </div>
                        </div>
                        <!--end::Step 3-->
